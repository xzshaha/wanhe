...
import com.wanhe.EnumConverter;
...
public final class SettingUtils {
	...
	public static Setting get() {
		...
		if (cacheElement != null) {
			...
			setting = new Setting();
			try {
				File wanheXmlFile = new ClassPathResource(CommonAttributes.wanhe_XML_PATH).getFile();
				Document document = new SAXReader().read(wanheXmlFile);
				List<Element> elements = document.selectNodes("/wanhe/setting");
	...
	public static void set(Setting setting) {
		try {
			...
			try {
				...
				fileOutputStream = new FileOutputStream(wanheXmlFile);
