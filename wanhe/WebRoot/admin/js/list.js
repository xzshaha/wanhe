$().ready( function() {
	...
	// 搜索选项
	$searchPropertySelect.click( function() {
		var $this = $(this);
		var offset = $this.offset();
		var $popupMenu = $this.parent().find(".dropdown-menu");
		$popupMenu.show();
		//var $popupMenu = $menuWrap.children("div.popupMenu");
	...
	$searchPropertyOption.click( function() {
		...
		$("#searchPropertyName").html($this.html());
		//$this.addClass("current");
		var $menu = $searchPropertySelect.parent().find(".dropdown-menu");
		$menu.hide();
		//$searchPropertySelect.find(".dropdown-menu").fadeOut();
		return false;
	});
