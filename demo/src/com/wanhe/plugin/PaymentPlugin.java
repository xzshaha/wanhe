...
//	private MerchantPaymentService merchantPaymentService;
	 ...
	 */
//	protected MerchantPayment getPayment(String sn) {
//		return merchantPaymentService.findBySn(sn);
//	}
	 ...
	 * @return 通知URL
	 */
	protected String getWxNotifyUrl(String sn, NotifyMethod notifyMethod) {
		Setting setting = SettingUtils.get();
		if (notifyMethod == null) {
			return setting.getSiteUrl() + "/mpayment/notify/" + NotifyMethod.general + "/" + sn + ".jhtml";
		}
		return setting.getSiteUrl() + "/mpayment/notify/" + notifyMethod + "/" + sn + ".jhtml";
	}
