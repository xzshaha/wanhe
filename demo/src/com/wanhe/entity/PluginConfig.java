 ...
 */
@Entity
@Table(name = "aps_plugin_config")
@SequenceGenerator(name = "sequenceGenerator", sequenceName = "aps_plugin_config_sequence")
public class PluginConfig extends OrderEntity {
	...
	@CollectionTable(name = "aps_plugin_config_attribute")
