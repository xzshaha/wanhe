...
public class Setting implements Serializable {
	...
	/** 定制顾问超过该时间未审核，后台提醒, (分钟). */
	private Integer orderPromptTime;

	/** 结算日. */
	private Integer settlementDate = 2;
	...
	/** 众筹平台最低分成. */
	private Double minPltCommission;
	/** 发起人最低认购比例. */
	private Double creatorBuyRatio;
	...
	/** 跑步机、动感单车1Km*/
	private  Integer sportKilometer;
	/** 跑步机、动感单车 最大*/
	private  Integer sportMax;
	
	
	/** 跳绳*/
	private  Integer jump;
	/** 跳绳100次积分*/
	private  Integer jumpHundred;
	/** 跳绳最大*/
	...
	/** 动态最大*/
	private  Integer dynamicMax;
	
	/** 点赞*/
	private  Integer praise;
	/** 点赞最大*/
	private  Integer praiseMax;
	...
	/** 每日第一名*/
	private  Integer dayRankingOne;
	/** 每日第二名*/
	private  Integer dayRankingTwo;
	/** 每日第三名*/
	private  Integer dayRankingThree;
	
	/** 每周第一名*/
	private  Integer weekRankingOne;
	/** 每周第二名*/
	private  Integer weekRankingTwo;
	/** 每周第三名*/
	private  Integer weekRankingThree;
	
	/** 每月第一名*/
	private  Integer monthRankingOne;
	/** 每月第二名*/
	private  Integer monthRankingTwo;
	/** 每月第三名*/
	private  Integer monthRankingThree;
	...
	/** 访客停车每小时价格*/
	private BigDecimal visterPrice;
	 ...
	 * @return
	 */
	public Integer getOrderPromptTime() {
		return orderPromptTime;
	}

	/**
	 * 设置订单提醒时间（分钟）
	 * @param orderPromptTime
	 */
	public void setOrderPromptTime(Integer orderPromptTime) {
		this.orderPromptTime = orderPromptTime;
	}
	...
	public Double getMinPltCommission() {
		return minPltCommission;
	}

	public void setMinPltCommission(Double minPltCommission) {
		this.minPltCommission = minPltCommission;
	}

	public Double getCreatorBuyRatio() {
		return creatorBuyRatio;
	}

	public void setCreatorBuyRatio(Double creatorBuyRatio) {
		this.creatorBuyRatio = creatorBuyRatio;
	}
	...
	public Integer getSportKilometer() {
		return sportKilometer;
	}

	public void setSportKilometer(Integer sportKilometer) {
		this.sportKilometer = sportKilometer;
	}

	public Integer getSportMax() {
		return sportMax;
	}

	public void setSportMax(Integer sportMax) {
		this.sportMax = sportMax;
	}
	...
	public Integer getJumpHundred() {
		return jumpHundred;
	}

	public void setJumpHundred(Integer jumpHundred) {
		this.jumpHundred = jumpHundred;
	}

	public Integer getJumpMax() {
		return jumpMax;
	}

	public void setJumpMax(Integer jumpMax) {
	...
	public Integer getDynamicMax() {
		return dynamicMax;
	}

	public void setDynamicMax(Integer dynamicMax) {
	...
	public Integer getPraiseMax() {
		return praiseMax;
	}

	public void setPraiseMax(Integer praiseMax) {
		this.praiseMax = praiseMax;
	}
	...
	public Integer getRockMax() {
		return rockMax;
	}

	public void setRockMax(Integer rockMax) {
	...
	public Integer getDayRankingOne() {
		return dayRankingOne;
	}

	public void setDayRankingOne(Integer dayRankingOne) {
		this.dayRankingOne = dayRankingOne;
	}

	public Integer getDayRankingTwo() {
		return dayRankingTwo;
	}

	public void setDayRankingTwo(Integer dayRankingTwo) {
		this.dayRankingTwo = dayRankingTwo;
	}

	public Integer getDayRankingThree() {
		return dayRankingThree;
	}

	public void setDayRankingThree(Integer dayRankingThree) {
		this.dayRankingThree = dayRankingThree;
	}

	public Integer getWeekRankingOne() {
		return weekRankingOne;
	}

	public void setWeekRankingOne(Integer weekRankingOne) {
		this.weekRankingOne = weekRankingOne;
	}

	public Integer getWeekRankingTwo() {
		return weekRankingTwo;
	}

	public void setWeekRankingTwo(Integer weekRankingTwo) {
		this.weekRankingTwo = weekRankingTwo;
	}

	public Integer getWeekRankingThree() {
		return weekRankingThree;
	}

	public void setWeekRankingThree(Integer weekRankingThree) {
		this.weekRankingThree = weekRankingThree;
	}

	public Integer getMonthRankingOne() {
		return monthRankingOne;
	}

	public void setMonthRankingOne(Integer monthRankingOne) {
		this.monthRankingOne = monthRankingOne;
	}

	public Integer getMonthRankingTwo() {
		return monthRankingTwo;
	}

	public void setMonthRankingTwo(Integer monthRankingTwo) {
		this.monthRankingTwo = monthRankingTwo;
	}

	public Integer getMonthRankingThree() {
		return monthRankingThree;
	}

	public void setMonthRankingThree(Integer monthRankingThree) {
		this.monthRankingThree = monthRankingThree;
	}
	...
	public void setHygiene(BigDecimal hygiene) {
	...
	public void setVideo(BigDecimal video) {
		this.video = video;
	}

	public int getBless_port() {
		return bless_port;
	}

	public void setBless_port(int bless_port) {
		this.bless_port = bless_port;
	}
	...
	public BigDecimal getVisterPrice() {
		return visterPrice;
	}

	public void setVisterPrice(BigDecimal visterPrice) {
		this.visterPrice = visterPrice;
	}
